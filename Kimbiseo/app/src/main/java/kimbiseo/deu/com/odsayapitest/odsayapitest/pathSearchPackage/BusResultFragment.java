...
public class BusResultFragment extends Fragment{
// 모든 길 찾기 프라그먼트
        ...
        public static BusResultFragment busresultfragment;
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                ...
                LinearLayout layout = (LinearLayout)inflater.inflate(R.layout.busresult_fragment,container,false);
                tableLayout=(TableLayout)layout.findViewById(R.id.busresultTable); // 테이블 레이아웃
                try {
                        MakePathinfoTable();
        ...
        private void MakePathinfoTable() throws JSONException {
                for (int rowcount = 0; rowcount < DataSingleton.INSTANCE.BigPathBus.size(); rowcount++) {
                        ArrayList<String> temponoffList=new ArrayList<String>();

                        JSONObject PathObject=DataSingleton.INSTANCE.BigPathBus.get(rowcount);
